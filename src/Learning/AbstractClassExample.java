...
/*
 * If a class is having 0 or more than 0 abstract method then we have to  define class as abstract
 ...
 *
 * 
 * Where as abstract class can contain final method because when we will create child class for that class
